...
export default function RankingsPage() {
  ...
  const handleRun = async () => {
    ...
    setRanking(true);
    try {
      const results = await jobApi.rank(selectedJob);
      ...
      {rankings.length > 0 && (
        <div className="grid grid-cols-4 gap-3">
          {[
            ...
            { label: "Top Probability", value: pct(rankings[0]?.hiring_probability), icon: Award, color: "text-violet-400" },
                        ...
                        <div className="mt-5 pt-5 border-t border-slate-700/50 grid grid-cols-1 lg:grid-cols-3 gap-6">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="mt-2 pt-2 border-t border-slate-800">
                              <div className="flex justify-between text-xs">
                                <span className="text-slate-500">Hiring Probability</span>
